...
def play_best_of(n):
    ...
    while player_wins < wins_necessary and computer_wins < wins_necessary:
        ...
        # tie
        if result == 0:
            print('It is a tie. Y0ou and the computer have both chosen {}. \n'.format(user))
        # you win
        elif result == 1:
            player_wins += 1
            print('Wohooo!! You chose {} and the computer chose {}. You won!\n'.format(user, computer))
        else:
            computer_wins += 1
            print('Oops!! You chose {} and the computer chose {}. You lost :(\n'.format(user, computer))
